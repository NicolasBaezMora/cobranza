...
class Customers extends CI_Controller {
  ...
  public function edit($id = NULL)
  {
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      /*$cst_data = $this->customers_m->array_from_post(['dni','first_name', 'last_name', 'gender', 'department_id', 'province_id', 'district_id', 'mobile', 'address', 'phone', 'email', 'business_name', 'ruc', 'company']);*/
      
      $cst_data = $this->customers_m->array_from_post(['dni','first_name', 'last_name', 'gender', 'mobile', 'address', 'phone', 'email', 'business_name', 'ruc', 'company']);
