  ...
  <div id="wrapper">
    <div id="receiptData" style="width: auto; max-width: 580px; min-width: 250px; margin: 0 auto;">
      <div id="receipt-data">
              ...
              <tbody>
                <?php foreach ($quotasPaid as $qp): ?>
                  <tr>
                    ...
                    <td class="text-right"><?php echo $qp->fee_amount; $total = $total + $qp->fee_amount;  ?></td>
        ...
        <span class="col-xs-12">
          <form id="sendPdf_form" method="post" action="<?php echo site_url('admin/payments/send_ticket'); ?>"> 
            <input type="hidden" name="cst_email" value="<?php echo $email_cst; ?>">
            <input type="hidden" name="name_cst" value="<?php echo $name_cst; ?>">
            <input type="hidden" name="loan_id" value="<?php echo $loan_id; ?>">
            <input type="hidden" name="coin" value="<?php echo $coin; ?>">
            <input type="hidden" name="quotasPaid" value="<?php echo htmlspecialchars(json_encode($quotasPaid)); ?>">
            <button type="submit" class="btn btn-block btn-primary">Enviar boleta al email</button>
          </form>
        </span>
