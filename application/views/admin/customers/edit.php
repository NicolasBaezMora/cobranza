  ...
  <div class="card-body">
    ...
    <div class="form-row">
      <div class="form-group col-md-3">
        <label class="small mb-1" for="inputUsername">Ingresar cedula</label>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-3">
        <label class="small mb-1" for="exampleFormControlTextarea1">Ingresar Email</label>
        <input class="form-control" id="inputUsername" type="email" name="email" value="<?php echo set_value('email', $this->input->post('email') ? $this->input->post('email') : $customer->email); ?>">
      </div>
    </div>
