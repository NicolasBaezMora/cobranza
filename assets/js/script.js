...
$(document).on('submit', '#sendPdf_form', function(event) {
    event.preventDefault();
    //var formElement = document.getElementById("sendPdf_form");
    //var data_send = new FormData(formElement);//tambien puede ser FormData(this)
    $.ajax( {
      ...
      success: function (resp) {
        if (resp.success) {
          Swal.fire({
            ...
            text: "Se envio correctamente el pdf al correo del cliente!!!",
            icon: 'success',
          ...
          Swal.fire({
            title: 'Oops! Error.',
            text: "Por favor intenta de nuevo después!!!",
            icon: 'error',
            confirmButtonColor: '#3085d6',
            confirmButtonText: 'Cerrar',
            allowOutsideClick: false
